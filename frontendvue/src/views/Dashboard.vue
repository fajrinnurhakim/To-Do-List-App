<template>
  ...
  <div class="container px-5 py-5 mx-auto my-16 space-y-5">
    ...
    <div class="space-y-5">
      ...
      >
        ...
        <div class="flex flex-row items-center space-x-2">
          <button @click="openModalForUpdate(todo)" class="btn btn-primary">
            Update
          </button>
    ...
    <div class="flex justify-center w-full">
      <div class="join">
        <button @click="goToPreviousPage" class="join-item btn btn-outline">
          Previous page
        </button>
  ...
  >
    <div class="p-4 space-y-2 rounded-lg bg-base-300 w-80 md:w-96 card">
      ...
      <button v-if="newTodo.id" @click="updateTodo()" class="btn btn-success">
        Update Todo
      </button>
