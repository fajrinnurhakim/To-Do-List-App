<template>
  <section id="home" class="flex h-screen bg-base-100">
    ...
    >
      <div class="flex flex-col items-center w-4/6 p-5 space-y-10 text-center">
        ...
        <p class="text-2xl text-white">
          Check. Plan. Achieve. With our Todolist App, Make Every Day Count!
        </p>
        <p class="text-justify text-white text-md">
          Our Todolist App streamlines your tasks, helping you plan efficiently,
          stay organized, and accomplish your goals. With easy task management
          and progress tracking, seize every opportunity to excel in your
          endeavors. Download now and maximize your productivity!
        </p>
      </div>
    </div>
  ...
  methods: {
    async handleLogin() {
      try {
        ...
        this.showToastError = true;
        this.toastMessageError = ('An error occurred during login.', error);
        setTimeout(() => {
          this.showToastError = false;
        }, 1000);
      }
